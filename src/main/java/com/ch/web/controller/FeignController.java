...
import com.ch.web.feign.FeignInterface;
...
public class FeignController {
    ...
    public String feign1(){
        ...
        return feignInterface.feign1();
    }

    @GetMapping("/feign2")
    public String feign2(@RequestHeader("name") String name){
        log.info("这里是消费者,正在测试feign的功能");
        return feignInterface.feign2(name);
    }

    @GetMapping("/feign3")
    public String feign3(){
        log.info("这里是消费者,正在测试feign的功能");
        return feignInterface.feign3(new User("哈哈哈",18));
    }

    @GetMapping("/feign4")
    public String feign4(){
        log.info("这里是消费者,正在测试feign的功能");
        return feignInterface.feign4();
    }

    @GetMapping("/feign5")
    public String feign5(@RequestHeader("name") String name){
        log.info("这里是消费者,正在测试feign的功能");
        return feignInterface.feign5(name);
    }

    @PostMapping("/feign6")
    public String feign6(){
        log.info("这里是消费者,正在测试feign的功能");
        return feignInterface.feign6(new User("哈哈哈",18));
    }
}
